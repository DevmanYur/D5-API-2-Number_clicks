    ...
    try:
        if is_bitlink(token, user_input):
            try:
                ...
                print(f'Вы ввели битлинк. Сумма кликов по данному битлинку: '
                      f'{total_clicks}')
            except requests.exceptions.HTTPError as err:
                if err.response.status_code == 402:
                    print('Вы ввели битлинк. '
                          'Подсчет количество кликов не входит '
                          'в ваш тарифный план на Bitly')
        else:
            try:
        ...
        print('Проверьте соединение и повторите попытку')
